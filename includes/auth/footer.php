		        ...
		        <div class="row">
		            <div class="col-xs-6 col-sm-3 col-md-3">
		                <div class="footer-menu-holder">
		                    ...
		                    <ul class="footer-menu">
		                        <li><a href="genericpages.php">About us</a></li>
		                        <li><a href="genericpages.php">News</a></li>
		                        <li><a href="genericpages.php">FAQ</a></li>
		                        <li><a href="genericpages.php">Contact us</a></li>
		                    </ul>
		                </div>
		            </div>
		            <div class="col-xs-6 col-sm-3 col-md-3">
		                <div class="footer-menu-holder">
		                    <h4>Services</h4>
		                    <ul class="footer-menu">
		                        <li><a href="genericpages.php">Bla bla</a></li>
		                        <li><a href="genericpages.php">More lipsium </a></li>
		                        <li><a href="genericpages.php">ipsium dolor</a></li>
		                        <li><a href="genericpages.php">Contact us</a></li>
		                    </ul>
		                </div>
		            </div>
		            <div class="col-xs-6 col-sm-3 col-md-3">
		                <div class="footer-menu-holder">
		                    <h4>Other links</h4>
		                    <ul class="footer-menu">
		                        <li><a href="genericpages.php">Customer Portal</a></li>
		                        <li><a href="genericpages.php">Support Portal</a></li>
		                    </ul>
		                </div>
		            </div>
		            <div class="col-xs-6 col-sm-3 col-md-3">
		                <div class="address-holder">
		                    <div class="phone"><i class="fa fa-phone"></i> +234 900 38502</div>
